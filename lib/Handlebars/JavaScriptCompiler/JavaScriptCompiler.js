 ...
 * @return {string}
 */
function produce_require_expression
  ( loaderAPI
  , resourcePath
  ) {
...
module.exports.produce_require_expression
  = produce_require_expression
 ...
 * @return {string}
 */
function produce_require_default_expression
  ( loaderAPI
  , resourcePath
  ) {
    if( !resourcePath ){ return undefined }
...
module.exports.produce_require_default_expression
  = produce_require_default_expression
...
function lookup_name
  ...
  , compilerContext
    ...
    const _produce_require_expression
    ...
    return (
      requireExpression
      || hb.JavaScriptCompiler.prototype.nameLookup.call
           ( compilerContext
           , parent
           , name
           , type
