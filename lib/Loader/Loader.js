...
function precompile_AST
  ( loaderOrError
    ...
    // see handlebarsRuntime.precompile definition (Handlebars-Lang,
  ...
  ( handlebarsLoader
    ...
    switch( inputCompatibility ) {
      case Input.Compatibility.HtmlLoader :
        return Input.html_loader_compatible
...
function run
  ( loaderOrError
    ...
    const preprocess_source = determine_preprocessor( loaderOrError )
