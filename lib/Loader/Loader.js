 ...
 *
 * @TODO:
 *   - loaderUtils.getOptions can throw an error, we need to catch this
 *     error and decide whether or not the configurations "failLoudly"
 *     option should influence whether or not the "re-throw" the error.
 *     My first thoughts are, no because this is the function that
 *     initializes our configuration, and we want make sure that our
 *     configuration is "corruption free" before moving forward.
 *     however, further analysis couldn't hurt.
 */
